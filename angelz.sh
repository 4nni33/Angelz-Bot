...
if wget -q https://github.com/4nni33/Angelz-Bot/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[1;35m"
git clone https://github.com/4nni33/Angelz-Bot.git
...
echo -e "\033[01;32m\033[01mIniciando Angelz!!\nStarting CatBot!!\n\033[0m"
npm start
